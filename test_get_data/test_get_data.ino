...
const char ssid[] PROGMEM = "butts";
const char password[] PROGMEM = "butts";
...
?>
 */
const char host[] PROGMEM = "monitree.herokuapp.com";
...
const char http_get_500_bytes_request[] PROGMEM = 
    "GET /monitree/v1/readings/14 HTTP/1.1\r\n";
...
const char http_post_request[] PROGMEM =
        "POST /monitree/v1/readings HTTP/1.1\r\n";
...
const char http_post_content[] PROGMEM = "{\"id\": 30, \"name\": \"tree\", \"date\": \"\", \"temp\": 77, \"creator\": \"sensor\", \"moisture\": 89, \"humidity\": 45, \"light\": 76, \"watered\": false }";

// Common headers.  Note that the close_connection string has a double CRLF.
const char http_useragent[] PROGMEM = "User-Agent: Monitree/0.1\r\n";
